...
|---|---|
| [Crear una solución de microservicios](crear-solucion-microservicios.md) | Comandos para crear la solución, los proyectos por capa y referenciarlos entre sí |
| [Gestión de paquetes NuGet](paquetes-nuget.md) | Instalar, eliminar y listar paquetes; paquetes esenciales recomendados por capa |
